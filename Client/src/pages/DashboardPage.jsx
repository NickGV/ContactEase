    ...
    <div className="container mx-auto p-6">
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-4">
          ...
          >
            <FontAwesomeIcon icon={faPlus} /> Nuevo Contacto
          </button>
          <button
          ...
          >
            <FontAwesomeIcon icon={faComments} /> Nuevo Chat
          </button>
        </div>
      </div>

      <div className="mb-10">
        <h2 className="text-lg font-semibold text-gray-800 mb-3">Contactos Recientes</h2>
