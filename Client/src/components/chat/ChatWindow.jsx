...
import { faPaperPlane, faUser, faXmark } from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    <div className="flex flex-col h-full bg-[#f7f8fa]">
      <div className="border-b border-gray-200 p-4 flex items-center justify-between bg-white">
        ...
        <button
          className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-100 text-gray-400 text-2xl"
