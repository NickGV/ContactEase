...
export const ContactDetails = () => {
  ...
  const { contacts, addToFavorites, deleteContact, handleEditContact, handleSelectedContact } =
      ...
      {!contactSelected ? (
        ...
        <>
          <div className="flex gap-3 items-center mb-4">
            ...
            <div>
              <p className="font-bold text-2xl">{contactSelected.name}</p>
              <p className="text-xl">{contactSelected.phoneNumber}</p>
              <a href={"somthing"} className="text-link underline text-xl">
